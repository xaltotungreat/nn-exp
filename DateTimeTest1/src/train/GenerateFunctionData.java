...
public class GenerateFunctionData {

	private static final String DELIMITER = ",";

	private static final int VALUES_NUMBER = 2000;

	private static final double ARGUMENT_LOW_BOUND = -5;
	private static final double ARGUMENT_HIGH_BOUND = 5;
	...
	public static void main(String[] args) {
		...
		try {
			Files.write(Paths.get("nnSinxXTrain1.tst"), sb, StandardOpenOption.CREATE, StandardOpenOption.WRITE);
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
	...
	public static double getNextFunctionValue(double argValue) {
		return Math.sin(argValue)*argValue;
	}
